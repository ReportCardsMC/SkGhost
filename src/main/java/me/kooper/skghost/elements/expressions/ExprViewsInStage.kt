...
class ExprViewsInStage : SimpleExpression<ChunkedViewData>() {
    ...
    companion object {
        init {
            Skript.registerExpression(
                ...
                ChunkedViewData::class.java, ExpressionType.SIMPLE, "[the] view(s) of stage %stage%", "[stage] %stage%('s) view(s)"
            )
        }
    }
